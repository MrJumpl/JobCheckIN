...
{
    public class AreaOfInterestMapper : MapperConfiguration
    {
        public override void ConfigureMappings(IConfiguration config, ApplicationContext applicationContext)
        {
            config.CreateMap<JobChIN_AreaOfInterest, AreaOfInterest>()
            ...
            config.CreateMap<AreaOfInterest, AreaOfInterestDto>();
        }
    }
}