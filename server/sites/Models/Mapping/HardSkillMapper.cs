...
{
    public class HardSkillMapper : MapperConfiguration
    {
        public override void ConfigureMappings(IConfiguration config, ApplicationContext applicationContext)
        {
            config.CreateMap<JobChIN_HardSkill, HardSkill>()
            ...
            config.CreateMap<HardSkill, HardSkillDto>();

            config.CreateMap<JobChIN_HardSkillSuggest, HardSkillSuggest>()
                .ReverseMap();
        }
    }
}